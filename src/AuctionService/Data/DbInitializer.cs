...
// Essa classe irá popular as tabelas que criamos no postgres
public class DbInitializer
{
    // Esse méotodo será o responsável por inicializar o banco de dados
    public static void InitDb(WebApplication app)
    {
        // Iremos criar um escopo para o serviço do banco de dados
        using var scope = app.Services.CreateScope();
        
        // Aqui iremos "seedar" (alimentar) o db
